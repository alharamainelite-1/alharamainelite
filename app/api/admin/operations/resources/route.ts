...
export async function PATCH(req:Request){
 ...
 const update:any={};if(b.assigned_host!==undefined)update.assigned_host=b.assigned_host||null;if(b.assigned_vehicle!==undefined)update.assigned_vehicle=b.assigned_vehicle||null;if(Object.keys(update).length===0)return NextResponse.json({error:"No assignment supplied."},{status:400});
