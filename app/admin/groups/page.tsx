...
export default async function GroupsPage(){
  ...
  return <section className="pb-12">
    <div className="eyebrow">Operations manager</div><h1 className="serif mt-2 text-4xl text-forest">Groups</h1><p className="mt-2 text-sm text-forest/55">Approved small-group planning and operational assignments.</p>
