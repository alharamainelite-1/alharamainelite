...
export default async function FinancePage(){
 ...
 return <section className="pb-12"><div className="mb-6"><div className="eyebrow">المالية والرقابة</div><h1 className="serif mt-2 text-4xl text-forest">المركز المالي</h1><p className="mt-2 text-sm text-forest/55">الإيرادات، المدفوعات الموثقة، تكاليف الخدمات، المصروفات، الموردون، الرواتب، المكافآت وربحية الرحلات.</p></div><FinanceCenter role={staff.profile.role}/></section>;
}
