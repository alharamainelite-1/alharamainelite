...
export const metadata: Metadata = {
  ...
  title: { default: 'ALHARAMAIN ELITE — A Journey Worth Remembering.', template: '%s | ALHARAMAIN ELITE' },
...
const structuredData = {
  '@context': 'https://schema.org', '@type': 'TravelAgency', name: siteConfig.brandName,
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://alharamainelite.vercel.app', description: siteConfig.description,
  telephone: siteConfig.whatsapp, areaServed: 'Worldwide', knowsLanguage: ['English','Somali','Arabic'],
};
